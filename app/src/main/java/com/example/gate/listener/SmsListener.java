        ...
        if (bundle != null) {
            try {
                ...
                for (int i = 0; i < msgs.length; i++) {
                    ...
                    Individual msgIndividual = Gate.FindGuyByPhone(gate.GATE_ALLOWED_INDIVIDUALS, msgPhone);
                    ...
                    if (msgBody.toLowerCase().trim().equals(openTextLowerCase)) {
                        ...
                        callIntent.setData(Uri.parse("tel:" + gate.GATE_INDIVIDUAL.Phone));
                        context.startActivity(callIntent);
                        Log.i("SmsListener", String.format("Calling %s...", gate.GATE_INDIVIDUAL.Name));
                    } else {
